...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2025 at 09:58 AM
...
--
ALTER TABLE `user_project`
  MODIFY `idUserProject` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `user_task`
--
ALTER TABLE `user_task`
  MODIFY `idUserTask` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
